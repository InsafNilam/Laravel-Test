...
export default function Index({
    ...
    const restoreBatch = () => {
        if (batchToRestore) {
            const promise = new Promise((resolve, reject) => {
                axios.post(
                    route("batches.restore", { batch: batchToRestore.id })
                );
                resolve();
            });
            promise.then(() => {
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            delete the batch and remove their data from our
                            servers.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This action will restore the batch that has already
                            deleted batch.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
